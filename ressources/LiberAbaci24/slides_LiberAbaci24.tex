...
\begin{frame}{It is important for Teaching}
  \begin{tcbProp}{When Teaching}
    \begin{enumerate}
      ...
      \onslide<4->{
      \begin{itemize}[label=$-$]
        \item There are too much features, or too many aspects to discuss
...
\begin{tcbProp}{For experts}
  \begin{enumerate}
    ...
    \item<5-> It help getting new users, and getting them more experts
    \item<6-> It enables to put forward and promote good practices
